...
class Stat():
    def __init__(self, stat_key, var_name = None, solve_strategy=SMART_SOLVER, display_name=None, report_stat = False):
...
class LinkedStat(Stat):
    def __init__(self, stat_key:str, linked_key:str, mapper:dict, var_name:str = None, display_name:str=None, report_stat:str = False):
        super().__init__(stat_key, var_name=var_name, solve_strategy=LINKED_SOLVER, display_name = display_name, report_stat = report_stat)
...
class SumStat(Stat):
    def __init__(self, stat_key:str, component_stats:list, var_name:str = None, display_name:str=None, report_stat:str = False):
        super().__init__(stat_key, var_name=var_name, solve_strategy=SUM_SOLVER, display_name = display_name, report_stat = report_stat)
...
class CustomStat(Stat):
    def __init__(self, stat_key:str, solve_function, var_name:str = None, display_name:str=None, report_stat:str = False):
        super().__init__(stat_key, var_name=var_name, solve_strategy=CUSTOM_SOLVER, display_name = display_name, report_stat = report_stat)
